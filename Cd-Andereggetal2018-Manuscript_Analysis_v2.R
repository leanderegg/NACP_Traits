...
results_dirname <- "20181208_results"
...
legend('topleft',legend = c("Spp means","Global", "Genera w/in Fam","Spp w/in Genus","W/in Spp"),col = c("grey","black",mypal[colchoices[c(3,2,1)]]), pch = c(16,NA,NA,NA,NA), lty=c(NA,1,1,1,1), lwd=c(NA,3,1,1,1)
